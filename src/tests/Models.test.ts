...
describe('QRCode class tests', () => {
    it('Main test', () => {
        ...
        expect(qrCode.modules[0]).to.eql([
            true,
            true,
            true,
            true,
        ...
        expect(qrCode.modules[1]).to.eql([
            true,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[2]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[3]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[4]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[5]).to.eql([
            true,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[6]).to.eql([
            true,
            true,
            true,
            true,
        ...
        expect(qrCode.modules[7]).to.eql([
            false,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[8]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[9]).to.eql([
            true,
            true,
            true,
            true,
        ...
        expect(qrCode.modules[10]).to.eql([
            false,
            false,
            true,
            false,
        ...
        expect(qrCode.modules[11]).to.eql([
            false,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[12]).to.eql([
            true,
            false,
            false,
            true,
        ...
        expect(qrCode.modules[13]).to.eql([
            false,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[14]).to.eql([
            true,
            true,
            true,
            true,
        ...
        expect(qrCode.modules[15]).to.eql([
            true,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[16]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[17]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[18]).to.eql([
            true,
            false,
            true,
            true,
        ...
        expect(qrCode.modules[19]).to.eql([
            true,
            false,
            false,
            false,
        ...
        expect(qrCode.modules[20]).to.eql([
            true,
            true,
            true,
            true,
